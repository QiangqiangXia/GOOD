...
class NewCombinationLoss(nn.Module):
    ...
    def forward(self,
        ...
        p = cls_score[torch.arange(cls_score.shape[0]), label]
        ...
        weight1[ce > 6.0] = ascent_rate[epoch]   # PON
        ...
        weight2[label == self.background_class] = 0.0
        weight2[label_false == self.background_class] = 0.0
